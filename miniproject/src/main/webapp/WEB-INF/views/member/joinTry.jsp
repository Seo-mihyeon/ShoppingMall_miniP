...
<link rel="stylesheet" href="/resources/css/member/joinTry.css">
<!-- 가입페이지는 css가 꽤 필요해서 따로 joinTry.css로 빼놨습니다. -->
<script src="https://code.jquery.com/jquery-3.4.1.js"
	integrity="sha256-WpOohJOqMqqyKL9FccASB9O0KwACQJpFTUBLTYOVvVU="
	crossorigin="anonymous"></script>
</head>
<body>
	<!-- 가입페이지에서는 1. 아이디 중복 체크 2. 비밀번호 일치 여부 3. 모든 항목값이 입력되어야 submit처리가 되는 스크립트가 적용되어있습니다. 
	따라서, 기본적으로 각 항목별로 input 태그의 속성값과 span 태그의 클래스명이 모두 동일해야합니다. -->
	<div class="wrapper">
		<!-- form 태그 동일하게 가주세요 -->
			...
			<div class="wrap">
				...
				<div class="id_wrap">
					...
					<div class="id_input_box">
						<!-- input class와 name 속성값 동일하게 가주세요  -->
						<input class="id_input" name="memberId">
					</div>
					<!-- span class명 동일하게 가주세요 -->
				...
				<div class="address_wrap">
					...
					<div class="address_input_1_wrap">
						<div class="address_input_1_box">
							<!-- input class, name, readonly 속성값 동일하게 가주세요  -->
